documentdocument.getElementById("flag").classList.add("hide");
...
function rollTheDice(){
  ...
  if(dice1 == dice2){
      ...
      document.getElementById("heading").style.color="var(--text-color)"; 
      document.getElementById("flag").style.fill="var(--text-color)";
   }
   else{
     document.getElementById("flag").classList.remove("hide"); 
